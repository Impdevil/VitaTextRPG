...
#define SQLITE_INTEGER  1   //  /* int */
#define SQLITE_FLOAT    2   //  /* double */
#define SQLITE_BLOB     4   //  /* blob */
#define SQLITE_NULL     5   //  /* NULL */
#ifdef SQLITE_TEXT          /* 3 is the default */
# undef SQLITE_TEXT 
...
SQLITE_API char* sqlite3_column_name(sqlite3_stmt*, int N);
...
SQLITE_API float sqlite3_column_double(sqlite3_stmt *stmt, int iCol);
SQLITE_API int sqlite3_column_blob(sqlite3_stmt *stmt, int iCol);
